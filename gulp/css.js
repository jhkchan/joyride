 ...
 */
gulp.task('css:foundation', gulp.series('scss:foundation', function () {
 ...
 * Outputs to buildPath.
 */
gulp.task('css:standalone', gulp.series('scss:standalone', 'css:foundation', function () {
 ...
 * Outputs to destPath.
 */
gulp.task('css:min', gulp.series('css:foundation', 'css:standalone', function () {
